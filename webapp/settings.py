...
SECRET_KEY = '%4)oh hi!5-cewqsjx#%t$sg-lolcatmb%leue1_^paa=(ft)e'
...
# Link the AccountProfile model directly the django User model 
AUTH_PROFILE_MODULE = 'talkcode.AccountProfile'

LOGIN_REDIRECT_URL = '/talkcode/'
LOGIN_URL = '/login/'

# Application level settings
DEVIDE_SENTENCES = False